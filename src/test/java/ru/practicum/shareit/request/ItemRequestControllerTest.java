...
public class ItemRequestControllerTest {
    ...
    @Test
    void testSaveItemRequestWithoutDescriptionAndStatus400() throws Exception {
    ...
    @Test
    void testGetAllRequestsWithWrongFromWithStatus400() throws Exception {
        mvc.perform(get("/requests/all?from=-2&size=2")
                        .header("X-Sharer-User-Id", 1L))
                .andExpect(status().isBadRequest());
    }
    ...
    @Test
    void testGetAllRequestsWithWrongSizeWithStatus400() throws Exception {
